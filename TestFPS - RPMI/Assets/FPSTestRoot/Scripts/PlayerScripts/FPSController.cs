...
using UnityEngine;
using UnityEngine.InputSystem; //Libreria para trabajar con el NewInputSystem
...
public class FPSController : MonoBehaviour
{
    ...
    public float maxForce = 1; //Limite de aceleración máxima
    ...
    void Movement()
    {
        ...
        //Calcular las fuerczas que afectan al movimiento
