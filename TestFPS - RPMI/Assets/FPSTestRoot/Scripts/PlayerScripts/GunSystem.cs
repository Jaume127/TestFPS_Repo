...
public class GunSystem : MonoBehaviour
{
    ...
    [Header("General Refereneces")]
    [SerializeField] Camera fpsCam; //Ref a la cámara desde la que se dispara
    [SerializeField] Transform shootPoint; //Ref a la posición de la cam para poder disparar desde ella
    ...
    public int bulletPerTap; //Cuantas balas se disparan de un solo disparo
